...
public class Hoctuvunglop5Activity extends AppCompatActivity {
    ListView lv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayBaihoc.add(new Baihoctuvung("Bai 1: Home","Action?",R.drawable.bai3));
        arrayBaihoc.add(new Baihoctuvung("Bai 2: Office","Table",R.drawable.bai4));
        arrayBaihoc.add(new Baihoctuvung("Bai 3: How old are you","one, two",R.drawable.bai5));
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(position == 0){
                    Intent in = new Intent(view.getContext(),baihoctuvung1lop5.class);
