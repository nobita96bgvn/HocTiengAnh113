...
public class Hocvideolop3Activity extends AppCompatActivity {
    public static String API_KEY = "AIzaSyDsVyu9oW2f5zqfGIiTVZoz7gNygMwCuR0";
    String ID_PLAYLIST ="PLo0UQ0hTNHJYb2aiBmDw7qspVdOnrxxoN";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvVideo.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(Hocvideolop3Activity.this, chayvideolop1.class);
            ...
            public void onResponse(JSONObject response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Hocvideolop3Activity.this, "Lỗi !!!", Toast.LENGTH_SHORT).show();
                    }
                }
        );
