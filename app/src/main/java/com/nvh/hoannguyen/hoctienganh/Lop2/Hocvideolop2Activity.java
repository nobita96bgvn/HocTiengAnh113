...
public class Hocvideolop2Activity extends AppCompatActivity {
    public static String API_KEY = "AIzaSyDsVyu9oW2f5zqfGIiTVZoz7gNygMwCuR0";
    String ID_PLAYLIST ="PL0T70KFE2wsK7KhpscCsPp4uCABfpRuVv";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvVideo.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(Hocvideolop2Activity.this, chayvideolop1.class);
            ...
            public void onResponse(JSONObject response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Hocvideolop2Activity.this, "Lỗi !!!", Toast.LENGTH_SHORT).show();
                    }
                }
        );
